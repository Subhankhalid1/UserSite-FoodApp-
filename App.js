  ...
  return (
    <Tab.Navigator initialRouteName="Home" tabBarOptions={{
      ...
      <Tab.Screen name="Home" component={Home} options={{
        tabBarIcon: ({ focused }) => {
          return <View style={{ alignItems: "center" }}>
            <Icon name="home" size={28} color={focused ? "#bad759" : "black"} />
          </View>
        }
      }} />
      <Tab.Screen name="Discover" component={Discover} options={{
        tabBarIcon: ({ focused }) => {
          return <View style={{ alignItems: "center" }}>
            <Icon name="map-pin" size={28} color={focused ? "#bad759" : "black"} />
          </View>
        }
      }} />
      <Tab.Screen name="Popular" component={Popular} options={{
        tabBarIcon: ({ focused }) => {
          return <View style={{ alignItems: "center" }}>
            <Icon name="star" size={28} color={focused ? "#bad759" : "black"} />
          </View>
        }
      }} />
      <Tab.Screen name="Profile" component={Profile} options={{
        tabBarIcon: ({ focused }) => {
          return <View style={{ alignItems: "center" }}>
            <Icon name="user" size={28} color={focused ? "#bad759" : "black"} />
          </View>
        }
      }} />
    </Tab.Navigator>
